...
from api.public_files.serializers import PublicFileSerializer, PubicFileDetailSerializer

from framework.auth.oauth_scopes import CoreScopes
from website.addons.public_file.model import NodePublicPage
...
class PublicFileDetails(JSONAPIBaseView, generics.RetrieveAPIView, WikiMixin):
...
class PublicFileContent(JSONAPIBaseView, generics.RetrieveAPIView, WikiMixin):
